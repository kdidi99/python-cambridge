...
def extract(path):
    ...
    t=0
    e=0
    #get data out of files using regex
...
def vibration(df):
    ...
    #find energy minimum in data frame and extract corresponding bond lengths and angles
    ...
    print("strech frequency: " + str(v1) + " cm-1")
    ...
    print("bend frequency: " + str(v2) + " cm-1")
    
    
def main():
    path = input("Please enter the directory pathname for your input files:\n")
    #e.g. C:/Users/Kieran/Documents/Programming/Python_Cambridge/ex2/H2Ooutfiles
    df = extract(path)
    plot(df)
    vibration(df)